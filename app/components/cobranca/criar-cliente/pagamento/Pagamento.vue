...
const dataInicio = defineModel<string>('dataInicio', { required: true })
...
const opcoesTipo = [
  { value: 'unico', label: 'Fiado', description: 'Uma cobrança avulsa para pagar no vencimento.', oculto: true },
...
<template>
  <section class="space-y-6">
    ...
    <div
      v-if="opcoesVisiveis.length > 0"
      class="grid max-w-md gap-3 md:grid-cols-1"
    >
      <button
    ...
    <div class="grid gap-4 md:grid-cols-2">
      <div class="space-y-1.5">
        ...
        <input v-model="dataInicio" type="date" :class="inputClass">
      </div>
