...
const { porEntregador } = storeToRefs(relatorios)
...
<template>
  <RelatoriosCard :delay="delay">
    ...
    <ul v-else class="space-y-1">
      ...
      >
        <div class="min-w-0">
          <p class="truncate font-body text-sm font-medium text-on-surface dark:text-dark-on-surface">
            {{ item.label }}
          </p>
