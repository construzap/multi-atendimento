...
const INPUT_CLASS =
  '!rounded-lg !border-outline/30 !bg-white !py-2 text-sm !text-on-surface dark:!border-dark-outline/30 dark:!bg-dark-surface-container-low dark:!text-dark-on-surface dark:placeholder:!text-dark-on-surface-variant/70'
