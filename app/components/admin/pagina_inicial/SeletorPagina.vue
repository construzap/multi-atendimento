...
const opcoes = [
  ...
  {
    id: 'custos-da-ia' as const,
    titulo: 'Custos da I.A',
    descricao: 'Acompanhe o consumo e os custos de inteligência artificial por workspace.',
    detalhe: 'Tokens, uso e custos da I.A',
